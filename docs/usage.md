...
[`nautical-units.md`](nautical-units.md). For how the unit abbreviations are
spelled, which ones are case-sensitive, and which pairs are easy to confuse,
see [`unit-abbreviations.md`](unit-abbreviations.md).
